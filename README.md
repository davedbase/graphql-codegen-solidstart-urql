...
**Note:** Subscriptions are NOT generated by this plugin since they are client-side only and don't work with SolidStart's SSR.

If you need subscriptions in your SolidStart app:
1. Use `@urql/solid` directly with `createSubscription` 
2. Or use the `typescript-solid-urql` plugin to generate typed subscription helpers

See the [typescript-solid-urql documentation](https://github.com/your-repo/graphql-codegen-solid-urql) for subscription code generation.
